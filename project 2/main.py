...
# %% IMDB DATA
df_2022 = pd.read_excel('imdb_data.xlsx', sheet_name='2022')
df_2021 = pd.read_excel('imdb_data.xlsx', sheet_name='2021')
df_2020 = pd.read_excel('imdb_data.xlsx', sheet_name='2020')
...
dfa['gross_lag'] = dfa.gross / dfa.gross.max()
fig = px.line(dfa, x='date_lag', y='gross_lag')
fig.show(renderer='browser')
...
dfaf = pd.DataFrame()
prices = np.round(np.linspace(15, 10, 21), 2)
